# 2.2 AboutMeInteractivity :woman:

## Descripcion
Repositorio en el que nos encontramos con una pequeña aplicacion para telefonos android que trate el apartado "Sobre nosotros". Este estará formando por un scroll vertical y un conjunto de textos e imagenes, ademas de un pequeño *input* en el cual, el usuario, podrá añadir un nuevo nombre de usuario junto con un botón que confirme dicha acción
